            ...
            <section className='menu position-relative  '>
                <div className="bradcamp bg-theme py-5 ">
                    <div className="position-relative z-3 container  text-center  " style={{ zIndex: '2' }}>
                        <h1 className='text-white fw-bold '>YOUR CART</h1>
                        <span className='text-white fw-semibold '>Home / Your Cart</span>
                    </div>
                                            ...
                                            <tr key={index}>
                                                <td className='d-flex justify-content-between align-items-center py-3'>
                                                    <div className="pro-img me-3">
                                                        <img src={item.img} alt="" className='image-fluid bor-rad' width={120} height={120} />
                                                    </div>
